...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GKMHUD)
...
AGKMHUD::AGKMHUD(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	PrimaryActorTick.bStartWithTickEnabled = false;
}

void AGKMHUD::PreInitializeComponents()
{
...
void AGKMHUD::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void AGKMHUD::GetDebugActorList(TArray<AActor*>& InOutList)
{
