...
#include "GKMGameViewportClient.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GKMGameViewportClient)
...
UGKMGameViewportClient::UGKMGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void UGKMGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
