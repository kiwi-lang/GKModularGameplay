...
// #include "AbilitySystem/GKMAbilitySet.h"

// Generated
#include "GKGFA_AddAbilities.generated.h"
...
class UGKMAbilitySet;

USTRUCT(BlueprintType)
struct FGKMAbilityGrant
{
	GENERATED_BODY()
...
class UGKGFA_AddAbilities final : public UGKGFA_WorldActionBase
{
	GENERATED_BODY()

public:
	//~ Begin UGKGFA interface
	virtual void OnGameFeatureActivating(FGameFeatureActivatingContext& Context) override;
	virtual void OnGameFeatureDeactivating(FGameFeatureDeactivatingContext& Context) override;
	//~ End UGKGFA interface
...
private:
	struct FActorExtensions
	{
		...
		TArray<FGKMAbilitySet_GrantedHandles> AbilitySetHandles;
	};
