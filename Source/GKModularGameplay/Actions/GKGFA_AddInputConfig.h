...
// Generated
#include "GKGFA_AddInputConfig.generated.h"
...
class UE_DEPRECATED(5.3, "UGKGFA_AddInputConfig has been deprecated. Please use UGKGFA_AddInputContextMapping instead.") LYRAGAME_API UGKGFA_AddInputConfig : public UGKGFA_WorldActionBase
{
	GENERATED_BODY()
