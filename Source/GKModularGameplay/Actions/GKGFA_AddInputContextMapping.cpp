...
// Include
#include "GKGFA_AddInputContextMapping.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GKGFA_AddInputContextMapping)

#define LOCTEXT_NAMESPACE "GameFeatures"

//////////////////////////////////////////////////////////////////////
// UGKGFA_AddInputContextMapping

void UGKGFA_AddInputContextMapping::OnGameFeatureRegistering()
{
...
void UGKGFA_AddInputContextMapping::OnGameFeatureActivating(FGameFeatureActivatingContext& Context)
{
...
void UGKGFA_AddInputContextMapping::OnGameFeatureDeactivating(FGameFeatureDeactivatingContext& Context)
{
...
void UGKGFA_AddInputContextMapping::OnGameFeatureUnregistering()
{
...
void UGKGFA_AddInputContextMapping::RegisterInputMappingContexts()
{
	RegisterInputContextMappingsForGameInstanceHandle = FWorldDelegates::OnStartGameInstance.AddUObject(this, &UGKGFA_AddInputContextMapping::RegisterInputContextMappingsForGameInstance);
...
void UGKGFA_AddInputContextMapping::RegisterInputContextMappingsForGameInstance(UGameInstance* GameInstance)
{
	if (GameInstance != nullptr && !GameInstance->OnLocalPlayerAddedEvent.IsBoundToObject(this))
	{
		GameInstance->OnLocalPlayerAddedEvent.AddUObject(this, &UGKGFA_AddInputContextMapping::RegisterInputMappingContextsForLocalPlayer);
		GameInstance->OnLocalPlayerRemovedEvent.AddUObject(this, &UGKGFA_AddInputContextMapping::UnregisterInputMappingContextsForLocalPlayer);
...
void UGKGFA_AddInputContextMapping::RegisterInputMappingContextsForLocalPlayer(ULocalPlayer* LocalPlayer)
{
...
void UGKGFA_AddInputContextMapping::UnregisterInputMappingContexts()
{
...
void UGKGFA_AddInputContextMapping::UnregisterInputContextMappingsForGameInstance(UGameInstance* GameInstance)
{
...
void UGKGFA_AddInputContextMapping::UnregisterInputMappingContextsForLocalPlayer(ULocalPlayer* LocalPlayer)
{
	if (ensure(LocalPlayer))
	{
		if (UEnhancedInputLocalPlayerSubsystem* EISubsystem = ULocalPlayer::GetSubsystem<UEnhancedInputLocalPlayerSubsystem>(LocalPlayer))
...
#if WITH_EDITOR
EDataValidationResult UGKGFA_AddInputContextMapping::IsDataValid(FDataValidationContext& Context) const
{
...
void UGKGFA_AddInputContextMapping::AddToWorld(const FWorldContext& WorldContext, const FGameFeatureStateChangeContext& ChangeContext)
{
...
void UGKGFA_AddInputContextMapping::Reset(FPerContextData& ActiveData)
{
...
void UGKGFA_AddInputContextMapping::HandleControllerExtension(AActor* Actor, FName EventName, FGameFeatureStateChangeContext ChangeContext)
{
...
void UGKGFA_AddInputContextMapping::AddInputMappingForPlayer(UPlayer* Player, FPerContextData& ActiveData)
{
...
void UGKGFA_AddInputContextMapping::RemoveInputMapping(APlayerController* PlayerController, FPerContextData& ActiveData)
{
