...
#if 0
// Include
#include "GKGFA_AddInputBinding.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GKGFA_AddInputBinding)

#define LOCTEXT_NAMESPACE "GameFeatures"

//////////////////////////////////////////////////////////////////////
// UGKGFA_AddInputBinding

void UGKGFA_AddInputBinding::OnGameFeatureActivating(FGameFeatureActivatingContext& Context)
{
...
void UGKGFA_AddInputBinding::OnGameFeatureDeactivating(FGameFeatureDeactivatingContext& Context)
{
...
#if WITH_EDITOR
EDataValidationResult UGKGFA_AddInputBinding::IsDataValid(FDataValidationContext& Context) const
{
...
void UGKGFA_AddInputBinding::AddToWorld(const FWorldContext& WorldContext, const FGameFeatureStateChangeContext& ChangeContext)
{
...
void UGKGFA_AddInputBinding::Reset(FPerContextData& ActiveData)
{
...
void UGKGFA_AddInputBinding::HandlePawnExtension(AActor* Actor, FName EventName, FGameFeatureStateChangeContext ChangeContext)
{
...
void UGKGFA_AddInputBinding::AddInputMappingForPlayer(APawn* Pawn, FPerContextData& ActiveData)
{
...
void UGKGFA_AddInputBinding::RemoveInputMapping(APawn* Pawn, FPerContextData& ActiveData)
{
	APlayerController* PlayerController = Cast<APlayerController>(Pawn->GetController());
