...
#include "GKGFA_AddGameplayCuePath.h"

#if WITH_EDITOR
#include "Misc/DataValidation.h"
#endif

#include UE_INLINE_GENERATED_CPP_BY_NAME(GKGFA_AddGameplayCuePath)

#define LOCTEXT_NAMESPACE "GameFeatures"

UGKGFA_AddGameplayCuePath::UGKGFA_AddGameplayCuePath()
{
...
#if WITH_EDITOR
EDataValidationResult UGKGFA_AddGameplayCuePath::IsDataValid(FDataValidationContext& Context) const
{
