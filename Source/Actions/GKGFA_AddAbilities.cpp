...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GKGFA_AddAbilities)
...
void UGKGFA_AddAbilities::OnGameFeatureActivating(FGameFeatureActivatingContext& Context)
{
...
void UGKGFA_AddAbilities::OnGameFeatureDeactivating(FGameFeatureDeactivatingContext& Context)
{
...
#if WITH_EDITOR
EDataValidationResult UGKGFA_AddAbilities::IsDataValid(FDataValidationContext& Context) const
{
...
void UGKGFA_AddAbilities::AddToWorld(const FWorldContext& WorldContext, const FGameFeatureStateChangeContext& ChangeContext)
{
			...
			for (const FGameFeatureAbilitiesEntry& Entry : AbilitiesList)
			{
				if (!Entry.ActorClass.IsNull())
				{
					UGameFrameworkComponentManager::FExtensionHandlerDelegate AddAbilitiesDelegate = UGameFrameworkComponentManager::FExtensionHandlerDelegate::CreateUObject(
						this, &UGKGFA_AddAbilities::HandleActorExtension, EntryIndex, ChangeContext);
...
void UGKGFA_AddAbilities::Reset(FPerContextData& ActiveData)
{
...
void UGKGFA_AddAbilities::HandleActorExtension(AActor* Actor, FName EventName, int32 EntryIndex, FGameFeatureStateChangeContext ChangeContext)
{
...
void UGKGFA_AddAbilities::AddActorAbilities(AActor* Actor, const FGameFeatureAbilitiesEntry& AbilitiesEntry, FPerContextData& ActiveData)
{
	check(Actor);
...
void UGKGFA_AddAbilities::RemoveActorAbilities(AActor* Actor, FPerContextData& ActiveData)
{
...
UActorComponent* UGKGFA_AddAbilities::FindOrAddComponentForActor(UClass* ComponentType, AActor* Actor, const FGameFeatureAbilitiesEntry& AbilitiesEntry, FPerContextData& ActiveData)
{
